  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1569511166187-97eb6e387e19?q=80&w=1820&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        }}
      >
        <div className="bg-gray-900 text-white rounded-3xl shadow-xl w-full max-w-screen-lg overflow-hidden">
